module ApplicationHelper
    ...
    def link_to_action(text, path, method)
        "<button class=\"btn btn-danger btn-lg btn-block\" onclick=\"document.location='#{path}' data-method='#{method}'\">#{text}</button>".html_safe
    end
end
